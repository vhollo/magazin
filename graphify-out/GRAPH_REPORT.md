# Graph Report - magazin  (2026-07-18)

## Corpus Check
- 191 files · ~4,544,901 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2129 nodes · 3581 edges · 134 communities (127 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d74eba43`
...
1. `ify` - 89 edges
2. `Dynamic Content Routes (`/[...path]`)` - 52 edges
3. `main()` - 46 edges
4. `scripts` - 45 edges
5. `Newsletter Route (`/hirlevel`)` - 40 edges
6. `Search Route (`/keres`)` - 36 edges
7. `Pharmacy Route (`/patika`)` - 35 edges
8. `decodeHtmlEntities()` - 30 edges
9. `buildRecipeFromModxDoc()` - 27 edges
10. `$lib/components/Nav.svelte` - 25 edges
...
Cohesion: 0.04
Nodes (45): scripts, build, check, check:watch, db:generate, db:introspect, db:migrate, db:push (+37 more)
...
Cohesion: 0.08
Nodes (50): modx_site_content, modx_site_htmlsnippets, modx_site_tmplvar_contentvalues, decodeDocPathId(), isMagazineCandidate(), isModxReferenceType(), isRootReferenceRow(), parseModxReferenceTargetId() (+42 more)
...
Cohesion: 0.17
Nodes (17): encodeDocPathId(), emptyContentFolderPaths(), pickDocFields(), PROJECTION_FIELDS, __dirname, loadFullProjectionFromFirestore(), loadProjectionDocsForSync(), mergeProjectionSnapshot() (+9 more)
...
Cohesion: 0.06
Nodes (66): applyPhotoCredit(), buildRecipeFromModxDoc(), buildRecipesFromModxDoc(), cardImgFromSrc(), cleanServingParenthetical(), countNutritionValues(), decodeHtmlEntities(), deriveAuthor() (+58 more)
...
Cohesion: 0.10
Nodes (33): recipeTeaserFromHit(), Category, IngredientGroup, IngredientItem, isRecipeFree(), KeresRecipeTeaser, LegacyHeroImage, normalizeRecipeAssetSrc() (+25 more)
...
Cohesion: 0.22
Nodes (6): $app/forms, $lib/components/ExpertSection.svelte, $lib/components/Hero.svelte, $lib/components/NewsletterCTA.svelte, $lib/components/SubscribeCTA.svelte, $lib/analytics

### Community 21 - "Community 21"
Cohesion: 0.14
Nodes (25): normalizeArticlePath(), addArticlesInBatches(), articleToSearchDoc(), buildAndUploadSearchIndex(), buildKeresRecipeTeaser(), changedListedPaths(), createMiniSearch(), __dirname (+17 more)

### Community 22 - "Community 22"
Cohesion: 0.15
Nodes (17): firebase/auth, actions, actions, GET(), RecipePublished, @sveltejs/kit, db, getAdminAuth() (+9 more)

### Community 23 - "Community 23"
Cohesion: 0.16
Nodes (17): load(), Banner, fetchKvizFromFirestore(), getCategories(), getKviz(), getScores(), getSiteConf(), loadCategoriesUncached() (+9 more)

### Community 24 - "Community 24"
Cohesion: 0.27
Nodes (12): cleanServingParenthetical(), countNutritionValues(), emptyNutritionTable(), normalizeReadableText(), normalizeServingUnit(), nutritionFieldPatterns(), parseNullableNumber(), parseNutritionFromRows() (+4 more)
...
Cohesion: 0.06
Nodes (31): Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`) (+23 more)
...
Cohesion: 0.11
Nodes (24): [], snapshot, ads, nav2, isReceptsarokRecipePath(), svelte, $app/navigation, snapshot (+16 more)

### Community 29 - "Community 29"
Cohesion: 0.14
Nodes (17): ensureFirebaseApp(), getFirestoreDb(), getFirebaseStorage(), resolveBucketName(), uploadPrivateFile(), uploadPublicFile(), purgeNetlifyPaths(), redirectPathForManifestEntry() (+9 more)
...
Cohesion: 0.15
Nodes (24): loadProjectionDocs(), parseReceptsarokRedirectPath(), loadRecipesFromJson(), arraysEqual(), buildDocIndex(), buildRecipeKeyByModxId(), computeRecipeRelatedChanges(), docRelatedKeys() (+16 more)
...
Cohesion: 0.09
Nodes (53): Collection slugs (precomputed at sync time), Dynamic Content Routes (`/[...path]`), Individual document routes, Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`) (+45 more)
...
Cohesion: 0.12
Nodes (15): cats, decodeModxParamEntities(), descToAltText(), isModxReferenceType(), isRootReferenceDoc(), loadReceptsarokRedirectMaps(), ModxSzerzoSnippet, ModxTransformDeps (+7 more)
...
Cohesion: 0.10
Nodes (19): Agent reminders, Analytics, Authentication Logic, Authentication Methods, Authentication State, Client-Side Logic (`+page.svelte`), Commands, Data Flow Summary (+11 more)
...
Cohesion: 0.21
Nodes (22): RecipePublished, Recipe, recipeSlug(), similarRecipesForTitle(), toLayoutRecipe(), getChildModxIds(), getSiblingReceptModxIds(), load() (+14 more)
...
Cohesion: 0.21
Nodes (15): classRe(), extractJuniorFields(), innerByClass(), innerH1(), matchNorm(), plain(), removeFirstIfMatches(), stripJuniorFields() (+7 more)
...
Cohesion: 0.11
Nodes (18): Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`) (+10 more)

### Community 56 - "Community 56"
Cohesion: 0.14
Nodes (14): Active State Highlighting, Additional Navigation Items, Collapse Logic (Mobile), Global typography (homepage redesign 2026), Mobile Menu Behavior, Navigation Component Logic (`Nav.svelte`), Navigation Item Types, Navigation System (+6 more)
...
Cohesion: 0.11
Nodes (25): deriveSyncRecipeAuthor(), normalizeGroup(), normalizeRecipeIngredientPunctuation(), normalizeScope(), stripTrailingListPunctuation(), appendUncategorizedReview(), buildReceptsarokRecipeForDoc(), loadCategoryReviewMap() (+17 more)
...
Cohesion: 0.20
Nodes (10): Data Freshness (`getKviz()` in `src/lib/siteConf.ts`), Layout Server (`+layout.server.ts`), Leaderboard Route (`/kviz/tabella`), Max Score Calculation (`getKviz()` in `src/lib/siteConf.ts`), Page Component (`+page.svelte`), Page Load (`+page.ts`), Quiz Form Route (`/kviz/form`), Quiz List Route (`/kviz`) (+2 more)
...
Cohesion: 0.16
Nodes (22): decodeHtmlEntities(), deriveInstructions(), deriveInstructionsHtml(), deriveServings(), deriveSubRecipes(), hasExplicitInstructionHeading(), hasMainStyleHozzavalokH2(), htmlToTextLines() (+14 more)
...
Cohesion: 0.17
Nodes (11): encodeDocPathId(), COLLECTION_SLUGS, CollectionDoc, fetchSiteStats(), getSearchMeta(), MagazineArticle, SearchMeta, SiteStats (+3 more)

### Community 80 - "Community 80"
Cohesion: 0.05
Nodes (38): Netlify Forms wiring (same indirection as `/kviz`), Newsletter Route (`/hirlevel`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`) (+30 more)

### Community 81 - "Community 81"
Cohesion: 0.12
Nodes (16): Components, Cross-linking with Magazine, Data Source, Dedupe & sync process (recipes), Dynamic matching, Existing-recipe update on re-save, Magazine → Receptsarok redirects (storage & processing), No existing match → sync-create (new recipe) (+8 more)

### Community 82 - "Community 82"
Cohesion: 0.24
Nodes (15): linkedModxIdsForRecipe(), applyPhotoCredit(), buildRecipeFromModxDoc(), buildRecipesFromModxDoc(), cardImgFromSrc(), deriveCategoryDecision(), deriveDocCreatedAtIso(), deriveImage() (+7 more)
...
Cohesion: 0.17
Nodes (11): NutritionValues, SubRecipe, CandidateLike, CompareRecipeResult, CompareRecipeScores, RecipeDedupeCandidate, chooseWinner(), compareRecipeCandidates() (+3 more)

### Community 101 - "Community 101"
Cohesion: 0.22
Nodes (12): decodeHtmlEntities(), NAMED_HTML_ENTITIES, extractAlairasAuthor(), extractPhotoCredit(), extractReceptjeAuthor(), deriveAuthor(), DATA_JSON, env() (+4 more)

### Community 102 - "Community 102"
Cohesion: 0.06
Nodes (32): Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`) (+24 more)
...
Cohesion: 0.42
Nodes (8): isMagazineRecipeDoc(), isReceptsarokLegacyModxPath(), matchReceptsarokLegacyPathAlias(), matchReceptsarokRedirectTarget(), redirectPathForTarget(), resolveReceptsarokRedirect(), titleMatchScore(), tokenize()

### Community 106 - "Community 106"
Cohesion: 0.16
Nodes (14): createReviewPath, patternsPath, readJson(), recipesPath, redirectsPath, root, testParsedBranchBCompleteness(), testParserDoesNotTreatRelatedLinksAsSubrecipe() (+6 more)
...
Cohesion: 0.33
Nodes (8): buildReceptsarokHome(), fetchReceptsarokHome(), getReceptsarokHome(), getMagazineStats(), getSiteStats(), load(), load(), resolveSiteCounts()

### Community 126 - "Community 126"
Cohesion: 0.12
Nodes (17): Individual Quiz Route (`/kviz/[...id]`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`) (+9 more)
...
## Knowledge Gaps
- **1071 isolated node(s):** `config`, `id`, `name`, `note`, `tags` (+1066 more)
...
- **Why does `stringifyRecipesJson()` connect `Community 71` to `Community 32`, `Community 130`, `Community 37`, `Community 133`, `Community 44`, `Community 14`, `Community 15`, `Community 23`, `Community 27`, `Community 30`?**
