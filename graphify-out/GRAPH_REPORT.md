...
## Corpus Check
- 180 files · ~4,528,526 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1896 nodes · 3187 edges · 132 communities (124 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d1dd20e1`
...
Cohesion: 0.13
Nodes (19): cats, createModxTransform(), decodeModxParamEntities(), descToAltText(), isModxReferenceType(), isRootReferenceDoc(), loadReceptsarokRedirectMaps(), ModxDoc (+11 more)
...
Cohesion: 0.12
Nodes (30): AUDIT_PATH, auditSkipNoRecipeBody(), buildRecipeModxIdSet(), CATEGORY_REVIEW_PATH, convertSubRecipesToParsedList(), CREATE_REVIEW_PATH, DATA_PATH, deriveSearchTerms() (+22 more)

### Community 15 - "Community 15"
Cohesion: 0.09
Nodes (54): applyPhotoCredit(), buildRecipeFromModxDoc(), buildRecipesFromModxDoc(), cardImgFromSrc(), cleanServingParenthetical(), countNutritionValues(), decodeHtmlEntities(), deriveAuthor() (+46 more)

### Community 16 - "Community 16"
Cohesion: 0.14
Nodes (19): categories, { data }, freeCount, freeCountsByCategory, totalRecipes, trial, $lib/components/MealPlanner.svelte, $lib/components/NutritionTable.svelte (+11 more)
...
Cohesion: 0.10
Nodes (27): recipeTeaserFromHit(), Category, IngredientGroup, IngredientItem, isReceptsarokRecipePath(), isRecipeFree(), KeresRecipeTeaser, LegacyHeroImage (+19 more)
...
Cohesion: 0.11
Nodes (23): [], snapshot, ads, hasReceptsarokAccess, nav2, $app/navigation, snapshot, $lib/ads.js (+15 more)
...
Cohesion: 0.15
Nodes (19): recipeHeroToCardImg(), buildReceptsarokHome(), Banner, consolidateRecipeImg(), getCategories(), getKviz(), getScores(), getSiteConf() (+11 more)
...
Cohesion: 0.18
Nodes (6): $app/forms, uid, kvizScores, $lib/kvizStore, $lib/marked, ./$types
...
Cohesion: 0.12
Nodes (20): isDescriptionAuthorCompatible(), titleMatchScore(), tokenizeTitle(), createReviewPath, patternsPath, readJson(), recipesPath, redirectsPath (+12 more)

### Community 30 - "Community 30"
Cohesion: 0.18
Nodes (12): firebase/auth, authReady, authUser, AuthUserType, email, apps, firebaseAuth, firebaseConfig (+4 more)
...
Cohesion: 0.26
Nodes (12): compareRecipeCandidates(), countNutritionValues(), countNutritionValuesFromTables(), hasNutritionAndIngredients(), hasRealAuthor(), hasRecipeIngredients(), hasRecipeNutrition(), hasVideo() (+4 more)
...
Cohesion: 0.17
Nodes (25): RecipePublished, RecipeLayoutEntry, recipeSlug(), similarRecipesForTitle(), stripRecipeGatedFields(), toLayoutRecipe(), getReceptsarokRecipe(), getChildModxIds() (+17 more)
...
Cohesion: 0.14
Nodes (10): PageProps, $app/environment, miniSearch, PageProps, patikas, query, $lib/components/Nav2.svelte, $lib/components/Search.svelte (+2 more)
...
Cohesion: 0.36
Nodes (6): encodeDocPathId(), emptyContentFolderPaths(), parentPathOf(), updateRelatedCards(), docsByTags(), writeCollections()
...
Cohesion: 0.33
Nodes (6): DocLike, homeDocs(), sortListedDocsByIdDesc(), ThinCard, toThinCard(), Tv
...
- **Why does `stringifyRecipesJson()` connect `Community 32` to `Community 33`, `Community 38`, `Community 11`, `Community 14`, `Community 82`, `Community 52`, `Community 23`, `Community 27`, `Community 127`?**
