# Graph Report - magazin  (2026-09-04)

## Corpus Check
- 207 files · ~4,577,052 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2304 nodes · 3916 edges · 141 communities (133 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `21d9ea3d`
...
1. `ify` - 89 edges
2. `Dynamic Content Routes (`/[...path]`)` - 62 edges
3. `scripts` - 53 edges
4. `main()` - 50 edges
5. `Newsletter Route (`/hirlevel`)` - 50 edges
6. `Search Route (`/keres`)` - 46 edges
7. `Pharmacy Route (`/patika`)` - 45 edges
8. `decodeHtmlEntities()` - 37 edges
9. `Collection slugs (precomputed at sync time)` - 29 edges
10. `Individual document routes` - 29 edges
...
Cohesion: 0.08
Nodes (43): decodeDocPathId(), appendUncategorizedReview(), buildReceptsarokRecipeForDoc(), loadCategoryReviewMap(), persistCreatedRecipes(), createReadCounter(), formatReadCounts(), totalReads() (+35 more)
...
Cohesion: 0.12
Nodes (38): stripLinkedRecipeBlocks(), applyPhotoCredit(), buildRecipeFromModxDoc(), buildRecipesFromModxDoc(), cardImgFromSrc(), deriveAuthor(), deriveCategoryDecision(), deriveDocCreatedAtIso() (+30 more)

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (27): load(), load(), toTeaser(), buildReceptsarokCategory(), buildReceptsarokHome(), buildReceptsarokTeasers(), fetchReceptsarokHome(), getReceptsarokCategory() (+19 more)
...
Cohesion: 0.09
Nodes (33): recipeTeaserFromHit(), Category, IngredientGroup, IngredientItem, isReceptsarokRecipePath(), isRecipeFree(), KeresRecipeTeaser, LegacyHeroImage (+25 more)
...
Cohesion: 0.19
Nodes (15): load(), Banner, fetchKvizFromFirestore(), getCategories(), getKviz(), getScores(), getSiteConf(), loadCategoriesUncached() (+7 more)

### Community 24 - "Community 24"
Cohesion: 0.15
Nodes (24): parseReceptsarokRedirectPath(), loadRecipesFromJson(), arraysEqual(), buildDocIndex(), buildRecipeKeyByModxId(), computeRecipeRelatedChanges(), docRelatedKeys(), pathParentOf() (+16 more)
...
Cohesion: 0.11
Nodes (23): [], snapshot, ads, nav2, svelte, $app/navigation, snapshot, snapshot (+15 more)
...
Cohesion: 0.15
Nodes (19): writeCollections(), DocLike, docsByTags(), EXPERT_TAGS, expertDocs(), hasDoctorAuthor(), homeDocs(), isExpertDoc() (+11 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (63): Collection slugs (precomputed at sync time), Dynamic Content Routes (`/[...path]`), Individual document routes, Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`) (+55 more)
...
Cohesion: 0.10
Nodes (27): NutritionValues, SubRecipe, CandidateLike, CompareRecipeResult, CompareRecipeScores, RecipeDedupeCandidate, redirectTargetForAliasPool(), chooseWinner() (+19 more)

### Community 37 - "Community 37"
Cohesion: 0.14
Nodes (15): blockText(), extractLinkedModxIds(), linkedModxIdsForRecipe(), apply, byDoc, collectionDocIds, docById, options (+7 more)
...
Cohesion: 0.12
Nodes (16): Analytics, Authors (`authors` collection, `/szerzok`), Client-Side Logic (`+page.svelte`), Config, Data Flow Summary, Expert picks (`expertCards`), FireCMS sync button (CMS → GitHub Actions), Home Route (`/`) (+8 more)
...
Cohesion: 0.21
Nodes (22): RecipePublished, recipeSlug(), similarRecipesForTitle(), toLayoutRecipe(), getReceptsarokRecipe(), getChildModxIds(), getSiblingReceptModxIds(), load() (+14 more)
...
Cohesion: 0.09
Nodes (23): Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`) (+15 more)
...
Cohesion: 0.19
Nodes (13): Author, AuthorLink, AuthorSupport, AuthorsSnapshot, fetchAuthors(), getAuthor(), getAuthors(), getAuthorsBySlugs() (+5 more)
...
Cohesion: 0.05
Nodes (44): Netlify Forms wiring (same indirection as `/kviz`), Newsletter Route (`/hirlevel`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`) (+36 more)
...
Cohesion: 0.29
Nodes (6): css.customData, css.lint.unknownAtRules, files.associations, *.css, less.lint.unknownAtRules, scss.lint.unknownAtRules
...
Cohesion: 0.26
Nodes (13): cleanServingParenthetical(), countNutritionValues(), decodeHtmlEntities(), emptyNutritionTable(), normalizeReadableText(), normalizeServingUnit(), nutritionFieldPatterns(), parseNullableNumber() (+5 more)
...
Cohesion: 0.14
Nodes (8): PageProps, NAMED_HTML_ENTITIES, $lib/components/AuthorSignature.svelte, $lib/components/Search.svelte, $lib/htmlEntities.js, $lib/authors, ./$types, ./$types
...
Cohesion: 0.36
Nodes (5): encodeDocPathId(), emptyContentFolderPaths(), root, parentPathOf(), updateRelatedCards()
...
Cohesion: 0.05
Nodes (41): Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`) (+33 more)
...
Cohesion: 0.27
Nodes (13): isDescriptionAuthorCompatible(), normalizeText(), isMagazineRecipeDoc(), isReceptsarokLegacyModxPath(), matchReceptsarokLegacyPathAlias(), matchReceptsarokRedirectTarget(), redirectPathForTarget(), resolveReceptsarokRedirect() (+5 more)
...
Cohesion: 0.33
Nodes (6): ensureFirebaseApp(), getFirestoreDb(), apply, approxDocSize(), main(), PUBLIC_FIELDS
...
## Knowledge Gaps
- **1154 isolated node(s):** `config`, `id`, `name`, `note`, `tags` (+1149 more)
...
- **Why does `stringifyRecipesJson()` connect `Community 29` to `Community 32`, `Community 37`, `Community 101`, `Community 8`, `Community 27`, `Community 14`, `Community 23`, `Community 24`, `Community 91`, `Community 93`, `Community 30`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `$lib/htmlEntities.js` connect `Community 96` to `Community 38`, `Community 11`, `Community 44`, `Community 82`, `Community 94`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Community 17` to `Community 106`, `Community 69`?**
