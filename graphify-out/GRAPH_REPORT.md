# Graph Report - magazin  (2026-07-08)

## Corpus Check
- 181 files · ~4,529,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1912 nodes · 3212 edges · 131 communities (124 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be165686`
...
8. `buildRecipesFromModxDoc()` - 21 edges
9. `customer` - 20 edges
10. `getFirestoreDb()` - 20 edges
...
Cohesion: 0.11
Nodes (20): load(), load(), RecipeLayoutEntry, toTeaser(), buildReceptsarokCategory(), buildReceptsarokTeasers(), getReceptsarokCategory(), getReceptsarokTeasers() (+12 more)
...
Cohesion: 0.07
Nodes (65): applyPhotoCredit(), buildRecipeFromModxDoc(), buildRecipesFromModxDoc(), cardImgFromSrc(), cleanServingParenthetical(), countNutritionValues(), decodeHtmlEntities(), deriveAuthor() (+57 more)
...
Cohesion: 0.10
Nodes (25): [], recipeTeaserFromHit(), snapshot, ads, hasReceptsarokAccess, nav2, isReceptsarokRecipePath(), $app/navigation (+17 more)
...
Cohesion: 0.19
Nodes (12): actions, GET(), RecipePublished, @sveltejs/kit, db, getAdminBucket(), getAdminDb(), hasReceptsarokAccessFromSubscription() (+4 more)
...
Cohesion: 0.10
Nodes (18): firebase/auth, $app/environment, $app/forms, authReady, authUser, AuthUserType, email, uid (+10 more)

### Community 27 - "Community 27"
Cohesion: 0.18
Nodes (18): loadProjectionDocs(), uploadProjectionSnapshot(), apply, CATEGORIES_PATH, deleteOrphanRecipes(), deleteRecipeDocs(), force, main() (+10 more)
...
Cohesion: 0.13
Nodes (19): compareRecipeCandidates(), titleMatchScore(), tokenizeTitle(), createReviewPath, patternsPath, readJson(), recipesPath, redirectsPath (+11 more)
...
Cohesion: 0.14
Nodes (26): applyModxLinkedRecipeFreeFlags(), parseReceptsarokRedirectPath(), targetKey(), loadRecipesFromJson(), stringifyRecipesJson(), arraysEqual(), buildDocIndex(), buildRecipeKeyByModxId() (+18 more)

### Community 33 - "Community 33"
Cohesion: 0.17
Nodes (15): DocLike, EXPERT_TAGS, expertDocs(), hasDoctorAuthor(), homeDocs(), isExpertDoc(), sortListedDocsByIdDesc(), ThinCard (+7 more)
...
Cohesion: 0.24
Nodes (12): hasRequiredRecipeBody(), countNutritionValues(), countNutritionValuesFromTables(), hasNutritionAndIngredients(), hasRealAuthor(), hasRecipeIngredients(), hasRecipeNutrition(), hasVideo() (+4 more)
...
Cohesion: 0.15
Nodes (13): Individual Quiz Route (`/kviz/[...id]`), Layout Server (`+layout.server.ts`), Max Score Calculation (`getKviz()` in `src/lib/siteConf.ts`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Load (`+page.ts`) (+5 more)

### Community 45 - "Community 45"
Cohesion: 0.15
Nodes (12): Agent reminders, Client-Side Logic (`+page.svelte`), Commands, Data Flow Summary, Expert picks (`expertCards`), Home Route (`/`), Key Libraries & Services, Magazine Content Sync (MODX → Firestore) (+4 more)
...
Cohesion: 0.11
Nodes (11): desiredByKey, recipes, RECIPES_PATH, review, REVIEW_PATH, recipeByKey, recipes, RECIPES_PATH (+3 more)
...
Cohesion: 0.17
Nodes (16): encodeDocPathId(), emptyContentFolderPaths(), pickDocFields(), PROJECTION_FIELDS, __dirname, loadFullProjectionFromFirestore(), loadProjectionDocsForSync(), mergeProjectionSnapshot() (+8 more)
...
Cohesion: 0.23
Nodes (13): Collection slugs (precomputed at sync time), Dynamic Content Routes (`/[...path]`), Individual document routes, Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Page Component (`+page.svelte`), Page Component (`+page.svelte`) (+5 more)
...
Cohesion: 0.25
Nodes (8): Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Search index (client-side), Search Route (`/keres`)
...
Cohesion: 0.29
Nodes (7): Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Pharmacy Route (`/patika`)
...
Cohesion: 0.50
Nodes (4): Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Subscription Route (`/elofizetes`)

## Knowledge Gaps
- **935 isolated node(s):** `config`, `id`, `name`, `note`, `tags` (+930 more)
...
- **Why does `stringifyRecipesJson()` connect `Community 32` to `Community 38`, `Community 11`, `Community 14`, `Community 15`, `Community 82`, `Community 52`, `Community 23`, `Community 27`?**
