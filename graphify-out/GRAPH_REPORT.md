# Graph Report - magazin  (2026-07-14)

## Corpus Check
- 190 files · ~4,541,297 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2080 nodes · 3490 edges · 134 communities (127 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8002bf3`
...
2. `scripts` - 45 edges
3. `main()` - 45 edges
4. `Dynamic Content Routes (`/[...path]`)` - 42 edges
5. `decodeHtmlEntities()` - 30 edges
6. `Newsletter Route (`/hirlevel`)` - 30 edges
7. `Search Route (`/keres`)` - 28 edges
8. `Pharmacy Route (`/patika`)` - 27 edges
9. `buildRecipeFromModxDoc()` - 26 edges
...
Cohesion: 0.16
Nodes (5): kvizScores, svelte/store, $lib/kvizStore, $lib/marked, ./$types
...
Cohesion: 0.09
Nodes (25): load(), load(), getPatikaCollection(), Patika, PatikaDoc, toKeresTeaser(), buildReceptsarokCategory(), buildReceptsarokTeasers() (+17 more)
...
Cohesion: 0.05
Nodes (85): decodeHtmlEntities(), NAMED_HTML_ENTITIES, applyPhotoCredit(), buildRecipeFromModxDoc(), buildRecipesFromModxDoc(), cardImgFromSrc(), cleanServingParenthetical(), countNutritionValues() (+77 more)
...
Cohesion: 0.10
Nodes (28): recipeTeaserFromHit(), Category, IngredientGroup, IngredientItem, isRecipeFree(), KeresRecipeTeaser, LegacyHeroImage, normalizeRecipeTeaser() (+20 more)
...
Cohesion: 0.11
Nodes (20): [], ads, nav2, svelte, snapshot, snapshot, $lib/ads.js, $lib/components/BannerSide.svelte (+12 more)
...
Cohesion: 0.17
Nodes (13): firebase/auth, actions, actions, GET(), RecipePublished, @sveltejs/kit, db, getAdminAuth() (+5 more)

### Community 23 - "Community 23"
Cohesion: 0.13
Nodes (22): load(), normalizeRecipeAssetSrc(), recipeHeroToCardImg(), Banner, consolidateRecipeImg(), fetchKvizFromFirestore(), getCategories(), getKviz() (+14 more)
...
Cohesion: 0.08
Nodes (25): Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`) (+17 more)
...
Cohesion: 0.14
Nodes (27): applyModxLinkedRecipeFreeFlags(), parseReceptsarokRedirectPath(), targetKey(), loadRecipesFromJson(), loadRedirectsManifest(), stringifyRecipesJson(), arraysEqual(), buildDocIndex() (+19 more)
...
Cohesion: 0.25
Nodes (22): Collection slugs (precomputed at sync time), Individual document routes, Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`) (+14 more)
...
Cohesion: 0.10
Nodes (20): Dynamic Content Routes (`/[...path]`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`) (+12 more)
...
Cohesion: 0.14
Nodes (14): Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`) (+6 more)
...
Cohesion: 0.15
Nodes (13): $app/environment, authReady, authUser, AuthUserType, email, uid, apps, firebaseAuth (+5 more)
...
Cohesion: 0.25
Nodes (15): linkedModxIdsForRecipe(), applyPhotoCredit(), buildRecipeFromModxDoc(), buildRecipesFromModxDoc(), cardImgFromSrc(), deriveAuthor(), deriveCategoryDecision(), deriveDocCreatedAtIso() (+7 more)
...
Cohesion: 0.07
Nodes (30): Netlify Forms wiring (same indirection as `/kviz`), Newsletter Route (`/hirlevel`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`), Page component (`+page.svelte`) (+22 more)
...
Cohesion: 0.17
Nodes (20): cleanServingParenthetical(), decodeHtmlEntities(), deriveInstructions(), deriveInstructionsHtml(), deriveServings(), htmlToTextLines(), idSlugFromRecipeTitle(), mergeSplitDecimalIngredientLines() (+12 more)
...
Cohesion: 0.07
Nodes (27): Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`), Layout Server (`+layout.server.ts`) (+19 more)
...
Cohesion: 0.09
Nodes (23): Data Freshness (`getKviz()` in `src/lib/siteConf.ts`), Individual Quiz Route (`/kviz/[...id]`), Layout Server (`+layout.server.ts`), Leaderboard Route (`/kviz/tabella`), Max Score Calculation (`getKviz()` in `src/lib/siteConf.ts`), Page Component (`+page.svelte`), Page Component (`+page.svelte`), Page Component (`+page.svelte`) (+15 more)
...
## Knowledge Gaps
- **1040 isolated node(s):** `config`, `id`, `name`, `note`, `tags` (+1035 more)
...
- **Why does `stringifyRecipesJson()` connect `Community 32` to `Community 100`, `Community 37`, `Community 71`, `Community 8`, `Community 44`, `Community 14`, `Community 124`, `Community 23`, `Community 27`, `Community 28`, `Community 30`?**
