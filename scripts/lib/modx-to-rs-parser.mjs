...
import { extractLinkedModxIds, stripLinkedRecipeBlocks } from '../../src/lib/modxLinkedRecipes.js'
import { extractAlairasAuthor, extractReceptjeAuthor, extractPhotoCredit } from '../../src/lib/modxAuthor.js'
