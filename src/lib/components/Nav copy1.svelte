...
<nav class="lg:sticky top-0 lg:-top-16 z-40">
  <nav class="top-0 left-0 w-full navbar lg:justify-center py-0">
    ...
    <div class="max-lg:flex-1"><a class="block p-2" href="/" on:click={_close_nav}><img class="h-12" src={'/assets/logo-diabetes2.svg'} alt="diabetes.hu"></a></div>
