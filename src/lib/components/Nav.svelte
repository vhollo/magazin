<script module>
  ...
  import { 
    ...
    signInWithEmailLink, 
    /* signInWithEmailAndPassword, setPersistence, browserLocalPersistence, getAdditionalUserInfo, */ 
    updateProfile, 
...
<nav class="sticky top-0 z-40 hover:z-50 bg-base-300 text-base-content navbar max-md-block max-md:flex-col justify-top py-0 min-h-12 h-12 max-md:overflow-y-auto">
  ...
  <div class="max-md:sticky max-md:top-0 h-12 flex-none items-center flex justify-between max-md:w-full bg-base-300 z-50">
