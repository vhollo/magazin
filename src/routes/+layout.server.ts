...
const queries = {
  ...
  's-o-s': ['diabpont'],
  'gdm': ['+árandósság'],
  'recept': ['+recept', '-táplálkozás'],
  'táplálkozás': ['táplálkozás', '-recept', '-covid-19'],
  ...
  'közösség': ['+közösség', '-egyesület', '-rendezvény', '-covid-19'],
  'egyesület': ['+egyesület', '-covid-19'],
  'esemény': ['+beszámoló', 'közösség', '-covid-19'],
  'rendezvény': ['+rendezvény', '-covid-19'],
  'hírek': ['rendezvény', 'beszámoló', 'közösség', 'egyesület', '-covid-19'],
  'portrék': ['+személyes', '+orvosok', '-kezelés', 'elismerés'],
  'sorstársak': ['+személyes', '-orvosok', '-kezelés', '-várandósság', '-közösség', '-edukáció', '-egyesület', '-covid-19'], 
  'tags': [],
}
